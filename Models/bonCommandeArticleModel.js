...
const schemaBonCommandeArticle=mongoose.Schema({ 
    ...
    bonCommande:{type: Schema.Types.ObjectId, ref: 'BonCommande'},
...
schemaBonCommandeArticle.plugin(mongoosePaginate);

schemaBonCommandeArticle.method("toJSON", function() {
    const { __v, _id, ...object } = this.toObject();
    object.id = _id;
    return object;
});

const BonCommandeArticle = mongoose.model('BonCommandeArticle',schemaBonCommandeArticle)


module.exports.BonCommandeArticle=BonCommandeArticle
