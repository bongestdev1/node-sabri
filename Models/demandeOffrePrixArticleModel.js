...
const schemaDemandeOffrePrixArticle=mongoose.Schema({ 
    ...
    demandeOffrePrix:{type: Schema.Types.ObjectId, ref: 'DemandeOffrePrix'},
...
schemaDemandeOffrePrixArticle.plugin(mongoosePaginate);

schemaDemandeOffrePrixArticle.method("toJSON", function() {
    const { __v, _id, ...object } = this.toObject();
    object.id = _id;
    return object;
});

const DemandeOffrePrixArticle = mongoose.model('DemandeOffrePrixArticle',schemaDemandeOffrePrixArticle)


module.exports.DemandeOffrePrixArticle=DemandeOffrePrixArticle
