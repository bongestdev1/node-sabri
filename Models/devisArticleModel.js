...
const schemaDevisArticle=mongoose.Schema({ 
...
schemaDevisArticle.plugin(mongoosePaginate);

schemaDevisArticle.method("toJSON", function() {
    const { __v, _id, ...object } = this.toObject();
    object.id = _id;
    return object;
});

const DevisArticle = mongoose.model('DevisArticle',schemaDevisArticle)

module.exports.DevisArticle=DevisArticle
