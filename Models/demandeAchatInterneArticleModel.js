...
const schemaDemandeAchatInterneArticle=mongoose.Schema({ 
    ...
    demandeAchatInterne:{type: Schema.Types.ObjectId, ref: 'DemandeAchatInterne'},
    quantiteLivree:{type:Number,default: 0},
   
    quantiteDemander:{type:Number,default: 0},
...
schemaDemandeAchatInterneArticle.plugin(mongoosePaginate);

schemaDemandeAchatInterneArticle.method("toJSON", function() {
    const { __v, _id, ...object } = this.toObject();
    object.id = _id;
    return object;
});

const DemandeAchatInterneArticle = mongoose.model('DemandeAchatInterneArticle',schemaDemandeAchatInterneArticle)


module.exports.DemandeAchatInterneArticle=DemandeAchatInterneArticle
