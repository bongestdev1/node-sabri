...
const schemaBonReceptionArticle=mongoose.Schema({ 
...
schemaBonReceptionArticle.plugin(mongoosePaginate);

schemaBonReceptionArticle.method("toJSON", function() {
    const { __v, _id, ...object } = this.toObject();
    object.id = _id;
    return object;
});

const BonReceptionArticle = mongoose.model('BonReceptionArticle',schemaBonReceptionArticle)


module.exports.BonReceptionArticle=BonReceptionArticle
