...
const schemaCommandeArticle=mongoose.Schema({ 
...
schemaCommandeArticle.plugin(mongoosePaginate);

schemaCommandeArticle.method("toJSON", function() {
    const { __v, _id, ...object } = this.toObject();
    object.id = _id;
    return object;
});

const CommandeArticle = mongoose.model('CommandeArticle',schemaCommandeArticle)


module.exports.CommandeArticle=CommandeArticle
