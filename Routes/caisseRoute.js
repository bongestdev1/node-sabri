...
router.post('/newCaisse', verifytoken, async (req, res) => {
    try {
...
router.post('/modifierCaisse/:id', verifytoken, async (req, res) => {
...
router.post('/deleteCaisse/:id', verifytoken, async (req, res) => {
...
router.post('/listCaisses', verifytoken, async (req, res) => {
