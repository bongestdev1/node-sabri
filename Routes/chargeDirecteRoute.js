 ...
 *
 */
router.post('/newChargeDirecte', verifytoken, async (req, res) => {
 ...
 *
 */
router.post('/modifierChargeDirecte/:id', verifytoken, async (req, res) => {
 ...
 */
router.post('/deleteChargeDirecte/:id', verifytoken, async (req, res) => {
 ...
 *
 */
router.post('/listChargeDirectes', verifytoken, async (req, res) => {
