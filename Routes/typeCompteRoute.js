...
router.post('/newTypeCompte', verifytoken, async (req, res) => {
...
router.post('/modifierTypeCompte/:id', verifytoken, async (req, res) => {
...
router.post('/deleteTypeCompte/:id', verifytoken, async (req, res) => {
...
router.post('/listTypeComptes', verifytoken, async (req, res) => {
