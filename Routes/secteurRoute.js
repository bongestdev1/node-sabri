...
router.post('/newSecteur',verifytoken, async(req,res)=>{
...
router.post('/modifierSecteur/:id',verifytoken, async(req,res)=>{
...
router.post('/deleteSecteur/:id',verifytoken, async(req,res)=>{
 ...
 */
 ...
 router.post('/listSecteurs',verifytoken, async(req,res)=>{
