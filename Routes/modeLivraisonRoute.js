...
router.post('/newModeLivraison',verifytoken ,  async(req,res)=>{
...
router.post('/modifierModeLivraison/:id',verifytoken , async(req,res)=>{
...
router.post('/deleteModeLivraison/:id',verifytoken , async(req,res)=>{
 ...
 */
 ...
 router.post('/listModeLivraisons',verifytoken , async(req,res)=>{
